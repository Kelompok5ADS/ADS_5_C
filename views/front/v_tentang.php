...
<!-- Meta tags -->
        <meta charset="utf-8">
        <meta name="description" content="Keep Animal" />
        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="sub-banner">
                    ...
                    <img src="<?php echo base_url().'theme/images/placeholders/coba.png'?>" alt="" />
                </div>
               ...
               <!-- Main Menu -->
                ...
                <div id="content" class="reservation">
                    <div class="container section">
                        ...
                        <div class="container section" style="margin-bottom: 400px;">
                            Keep-Animal adalah sistem informasi berbasis web yang menyediakan layanan real time pemeliharaan, pengawasan terhadap satwa khususnya hewan dilindungi
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container section end">
                        <div id="footer-about" class="one-fourth column">
                            ...
                            <p>
                                ...
                                <span>Jl. Brigjen Slamet Riyadi Gg. 5 No. 6A</span>
                ...
                <div id="copyright">
                    <div class="container section end">
                        ...
                        <span id="text">Copyright &copy; <?php date_default_timezone_set('Asia/Jakarta'); echo date('Y');?> | <a href="http://elektro.um.ac.id">Sandika Maulana Putra</a>.</span>
