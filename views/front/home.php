...
<html lang="id">
    ...
    <head>
        <title>Keep Animal</title>

        <!-- Meta tags -->
        <meta charset="utf-8">
        <meta name="description" content="Sistem Informasi Keep Animal" />
        <meta name="author" content="Sandika Maulana Putra" />
    ...
    <body>
        ...
        <!-- Background Image -->
        <img src="<?php echo base_url().'theme/images/batu.jpg'?>" class="bg" alt="" />
            ...
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="banner">
                    ...
                    <div id="banner-slider" class="flexslider">
                        <ul class="slides">
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/satwa.jpg'?>" alt="" />
                            </li>
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/harimau.jpg'?>" alt="" />
                            </li>
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/jerapah.jpg'?>" alt="" />
                            </li>
                        </ul>
                    </div>
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Welcome to Keep Animal</span></h1>
                        <p style="text-align: center;">
                            Keep Animal Adalah sistem informasi web yang menyediakan layanan real time kebun binatang dengan fitur pemeliharaan dan pelaporan yang efektif dan efisien
                        </p>
                        <p>
                    ...
                    <div class="container section end">
                        <div id="footer-about" class="one-fourth column">
                            ...
                            <p>
                                ...
                                <span>Jl. Brigjen Slamet Riyadi Gg. 5 No. 6 A</span>
                                <span>Telp: 0341 333315</span>
                            </p>
                            <p>
                                <span>Telp: 0341 333315</span>
                                <span>Fax: 0341 333315</span>
                                <span>Email: maulanasandika12@gmail.com</span>
                            </p>
                        </div>
                ...
                <div id="copyright">
                    <div class="container section end">
                        ...
                        <span id="text">Copyright &copy; <?php date_default_timezone_set('Asia/Jakarta'); echo date('Y');?> | <a href="http://elektro.uma.ac.id">Sandika Maulana Putra</a>.</span>
